...
void	error(t_lem *l, int e)
{
	...
	(e == NB_ANT) ? ft_putstr_fd("Invalid ant number\n", 2) : 0;
	(e == NAME_ROOM) ? ft_putstr_fd("Invalid room name\n", 2) : 0;
	(e == COOR_ROOM) ? ft_putstr_fd("Invalid coordinate\n", 2) : 0;
	(e == INFO_START) ? ft_putstr_fd("Invalid info for start\n", 2) : 0;
	(e == INFO_END) ? ft_putstr_fd("Invalid info for end\n", 2) : 0;
	...
	(e == LINK) ? ft_putstr_fd("Invalid link\n", 2) : 0;
	if (e == LINK_NAME)
	{
		ft_putstr_fd("Invalid room name : ", 2);
